...
4. Update user-facing README and skill help.
5. Run focused unit tests, real public data smoke, Bazel Python ecosystem regression, diff review, and secret scan.
6. Commit, push, and track PR CI.
