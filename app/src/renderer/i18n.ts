...
export const I18N: Record<Locale, Record<string, string>> = {
  en: {
    ...
    embedding_provider_placeholder: 'provider id',
    embedding_model_placeholder: 'model id',
    embedding_template_placeholder: 'template or prompt version',
  ...
  zh: {
    ...
    embedding_provider_placeholder: 'provider id',
    embedding_model_placeholder: 'model id',
    embedding_template_placeholder: 'template 或 prompt 版本',
    embedding_vector_placeholder: 'embedding',
    embedding_ready: 'Embedding 已配置',
